...
public class BigFraction {
	...
	public BigFraction subtract(BigFraction b){
		BigFraction result = new BigFraction((numer.multiply(b.denom)).subtract(b.numer.multiply(denom)), denom = denom.multiply(b.denom));
		result.simplify();
		return result;
	}
	...
	public boolean equals(BigFraction b){
		return (this.numer.equals(b.numer) && this.denom.equals(b.denom));
	}
